...
export default function Home() {
  ...
  return (
    <main className="flex rounded container gap-10 items-start justify-between p-10 shadow-2xl bg-white">
      <div className="flex-1">
        <Sidebar />
      </div>
      {/* <button onClick={()=>dispatch(goToPage(pageStatus +1 ))} className="bg-cyan-600 my-20">Change Page</button> */}
      <div className="flex-2 w-full flex flex-col items-center min-h-[640px]">
        <StageOne />
      </div>
    </main>
  );
